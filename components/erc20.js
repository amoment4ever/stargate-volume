...
class ERC20Contract {
  ...
  transfer(to, value, options) {
    return this.contract.methods.transfer(to, value).send(options);
  }

  approve(spender, value, options) {
    return this.contract.methods.approve(spender, value).send(options);
  }
